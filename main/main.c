...
#define ADC_GPIO_NUM            GPIO_NUM_1  // ADC引脚（GPIO1, ADC1_CH1）
#define ADC_LON_GPIO_NUM        GPIO_NUM_5  // ADC状态负引脚（GPIO5） 低电平有效
#define ADC_LOP_GPIO_NUM        GPIO_NUM_6  // ADC状态正引脚（GPIO6） 低电平有效
#define ADC_CONTROL_GPIO_NUM    GPIO_NUM_7  // ADC控制引脚（GPIO7） 低电平有效
#endif
...
#define TOUCH_SPI_MOSI          GPIO_NUM_20 // 触摸屏spi输入
...
#elif CONFIG_IDF_TARGET_ESP32S3
#define ADC_OUTPUT_TYPE             ADC_DIGI_OUTPUT_FORMAT_TYPE2// ESP32S3使用Type2格式
#define ADC_GET_CHANNEL(p_data)     ((p_data)->type2.channel)   // 从Type2数据中提取通道号
#define ADC_GET_DATA(p_data)        ((p_data)->type2.data)      // 从Type2数据中提取采样值
#endif
...
#elif CONFIG_IDF_TARGET_ESP32S3
static adc_channel_t channel[1] = {ADC_CHANNEL_1};              // ESP32S3使用通道1(GPIO1)
#endif
